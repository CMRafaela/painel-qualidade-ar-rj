...
export default function Home() {
  ...
  // filtra os dados com base nos filtros selecionados de bairro e qualidade do ar:
          ...
          <>
            <div className="flex flex-wrap gap-4 justify-center w-full">
              <Filtro
                ...
                valorSelecionado={bairroSelecionado} 
                opcoes={bairros}
                onChange={setBairroSelecionado}
              />
              
              <Filtro 
                label="Todas as qualidades" 
                valorSelecionado={qualidadeSelecionada}
                opcoes={qualidades}
                onChange={setQualidadeSelecionada}
              />
